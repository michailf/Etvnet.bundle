...
@route(PREFIX + '/live_channels_menu')
...
@route(PREFIX + '/add_favorite_channel')
...
@route(PREFIX + '/remove_favorite_channel')
...
@indirect
@route(PREFIX + '/play_video_wrapper_live')
...
@route(PREFIX + '/play_list_live.m3u8')
